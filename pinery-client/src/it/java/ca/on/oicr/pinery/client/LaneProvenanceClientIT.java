...
public class LaneProvenanceClientIT {
  ...
  public static void setupClass() throws FileNotFoundException, IOException, HttpResponseException {
    ...
    Collections.sort(
        lps,
        new Comparator<LaneProvenanceDto>() {
          @Override
  ...
  public void testGetSequencerRunAttributes() {
    ...
    assertEquals(
        "{instrument_name=[h001], run_bases_mask=[y51,y51], run_dir=[/test/dir/1]}",
        lpById.get("1_1").getSequencerRunAttributes().toString());
    assertEquals(
        "{instrument_name=[h001], run_bases_mask=[y51,y51], run_dir=[/test/dir/1]}",
        lpById.get("1_2").getSequencerRunAttributes().toString());
    assertEquals(
        "{instrument_name=[h002], run_bases_mask=[y151,I8,y151], run_dir=[/test/dir/2]}",
        lpById.get("2_1").getSequencerRunAttributes().toString());
    assertEquals(
        "{instrument_name=[h002], run_bases_mask=[y151,I8,y151], run_dir=[/test/dir/2]}",
        lpById.get("2_2").getSequencerRunAttributes().toString());
    assertEquals(
        "{instrument_name=[h002], run_bases_mask=[y75,I6,y75], run_dir=[/test/dir/3]}",
        lpById.get("3_5").getSequencerRunAttributes().toString());
  }
  ...
  public void checkLastModified() {
    ...
    assertEquals(
        ...
        lpById.get("1_1").getLastModified().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-07-14T14:51:36Z").toString(),
        lpById.get("1_2").getLastModified().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-07-14T14:51:36Z").toString(),
        lpById.get("2_1").getLastModified().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-07-14T14:51:36Z").toString(),
        lpById.get("2_2").getLastModified().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2016-03-03T20:00:01Z").toString(),
        lpById.get("3_5").getLastModified().toInstant().toString());
  }
  ...
  public void checkCreatedDate() {
    ...
    assertEquals(
        ZonedDateTime.parse("2015-07-11T14:51:36Z").toString(),
        lpById.get("1_1").getCreatedDate().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-07-11T14:51:36Z").toString(),
        lpById.get("1_2").getCreatedDate().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-07-11T14:51:36Z").toString(),
        lpById.get("2_1").getCreatedDate().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-07-11T14:51:36Z").toString(),
        lpById.get("2_2").getCreatedDate().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2016-03-01T20:00:01Z").toString(),
        lpById.get("3_5").getCreatedDate().toInstant().toString());
  }
  ...
  public void checkVersion() throws HttpResponseException {
    ...
    assertEquals(
        "9c189f79b14939e754387b226122fd91f5fe6bdda268791945ebbb34751fa9fc",
        lpById.get("1_1").getVersion());
    assertEquals(
        "d55fdada5383f60ca4a176f249f049b8df63c79567bbd3dd8d8f1859f279567f",
        lpById.get("1_2").getVersion());
    assertEquals(
        "7b6e3ca94927071fc5d1042a0668bed582911725ae40b0a805f16049008d9ab6",
        lpById.get("2_1").getVersion());
    assertEquals(
        "2dab64b79479422c92d4d0e16aa5ee006ddf28fcb5fb0a8eef548d6e2d6d261a",
        lpById.get("2_2").getVersion());
    assertEquals(
        "29d03544d5c40e01e6d67941a8941b02a53e3b05c659912a2e7a491927bf46d5",
        lpById.get("3_5").getVersion());
  }
}
