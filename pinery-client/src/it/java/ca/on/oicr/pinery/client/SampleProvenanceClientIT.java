...
public class SampleProvenanceClientIT {
  ...
  public static void setupClass() throws FileNotFoundException, IOException, HttpResponseException {
    ...
    Collections.sort(
        sps,
        new Comparator<SampleProvenanceDto>() {
          @Override
  ...
  public void testGetSampleAttributes() {
    ...
    assertEquals(
        "{geo_organism=[Homo sapiens], geo_prep_kit=[Kit 1], geo_run_id_and_position=[1_1], geo_template_type=[Illumina PE Library], geo_tissue_origin=[nn], geo_tissue_type=[n]}",
        spById.get("1_1_2").getSampleAttributes().toString());
    assertEquals(
        "{geo_organism=[Homo sapiens], geo_prep_kit=[Kit 1], geo_run_id_and_position=[1_2], geo_template_type=[Illumina PE Library], geo_tissue_origin=[nn], geo_tissue_type=[n]}",
        spById.get("1_2_3").getSampleAttributes().toString());
    assertEquals(
        "{geo_organism=[Homo sapiens], geo_prep_kit=[Kit 1], geo_run_id_and_position=[2_1], geo_template_type=[Illumina PE Library], geo_tissue_origin=[nn], geo_tissue_type=[n]}",
        spById.get("2_1_2").getSampleAttributes().toString());
    assertEquals(
        "{geo_organism=[Homo sapiens], geo_prep_kit=[Kit 1], geo_run_id_and_position=[2_1], geo_targeted_resequencing=[Illumina TruSeq Exome], geo_template_type=[Illumina PE Library], geo_tissue_origin=[nn], geo_tissue_type=[n]}",
        spById.get("2_1_3").getSampleAttributes().toString());
    assertEquals(
        "{geo_organism=[Homo sapiens], geo_prep_kit=[Kit 1], geo_run_id_and_position=[2_2], geo_template_type=[Illumina PE Library], geo_tissue_origin=[nn], geo_tissue_type=[n]}",
        spById.get("2_2_4").getSampleAttributes().toString());
    assertEquals(
        "{geo_organism=[Homo sapiens], geo_prep_kit=[Kit 1], geo_run_id_and_position=[2_2], geo_targeted_resequencing=[Illumina TruSeq Exome], geo_template_type=[Illumina PE Library], geo_tissue_origin=[nn], geo_tissue_type=[n]}",
        spById.get("2_2_5").getSampleAttributes().toString());
    assertEquals(
        "{geo_library_source_template_type=[WG], geo_organism=[Homo sapiens], geo_prep_kit=[Kit 1], geo_run_id_and_position=[3_5], geo_targeted_resequencing=[Illumina TruSeq Exome], geo_template_type=[Illumina PE Library], geo_tissue_origin=[Ly], geo_tissue_type=[R]}",
  ...
  public void testGetSequencerRunAttributes() {
    ...
    assertEquals(
        "{instrument_name=[h001]}", spById.get("1_1_2").getSequencerRunAttributes().toString());
    assertEquals(
        "{instrument_name=[h001]}", spById.get("1_2_3").getSequencerRunAttributes().toString());
    assertEquals(
        "{instrument_name=[h002]}", spById.get("2_1_2").getSequencerRunAttributes().toString());
    assertEquals(
        "{instrument_name=[h002]}", spById.get("2_1_3").getSequencerRunAttributes().toString());
    assertEquals(
        "{instrument_name=[h002]}", spById.get("2_2_4").getSequencerRunAttributes().toString());
    assertEquals(
        "{instrument_name=[h002]}", spById.get("2_2_5").getSequencerRunAttributes().toString());
    assertEquals(
        "{instrument_name=[h002]}", spById.get("3_5_8").getSequencerRunAttributes().toString());
  }
  ...
  public void checkLastModified() {
    assertEquals(
        ZonedDateTime.parse("2015-07-14T14:51:36Z").toString(),
        spById.get("1_1_2").getLastModified().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-08-01T20:56:20Z").toString(),
        spById.get("1_2_3").getLastModified().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-07-14T14:51:36Z").toString(),
        spById.get("2_1_2").getLastModified().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-08-01T20:56:20Z").toString(),
        spById.get("2_1_3").getLastModified().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-09-01T20:56:20Z").toString(),
        spById.get("2_2_4").getLastModified().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2015-10-01T20:56:20Z").toString(),
        spById.get("2_2_5").getLastModified().toInstant().toString());
    assertEquals(
        ZonedDateTime.parse("2016-03-05T20:00:01Z").toString(),
        spById.get("3_5_8").getLastModified().toInstant().toString());
  }
  ...
  public void checkVersion() throws HttpResponseException {
    ...
    assertEquals(
        "bff43683a88d5eb84a234381f59bebd22b5a2b7de7e43099b3ea5a6529793a09",
        spById.get("1_1_2").getVersion());
    assertEquals(
        "ac562975caacce6789bd10552f17fc6103377ece0b186b65667d6b61d71dfbfc",
        spById.get("1_2_3").getVersion());
    assertEquals(
        "162715dd5c52407e544096494aeee472a6bdd6339ad8898d9caefae1e51104fa",
        spById.get("2_1_2").getVersion());
    assertEquals(
        "fd238c945ebdb1200e2c348bbd5107568afcf66fdf7164b1f76490ff9e7da75d",
        spById.get("2_1_3").getVersion());
    assertEquals(
        "b461d8de3ab867f3ef276056ad623d0f52a3df7827a990010218531b23a4fe15",
        spById.get("2_2_4").getVersion());
    assertEquals(
        "d9c4030cac3267c20a72ac62d9eea1d12493e9ded6305f23d819a0faeaffac31",
        spById.get("2_2_5").getVersion());
    assertEquals(
        "d85524f6601351a2896bcc06ead576eb0bdebdfedb9678c256d4395a54cf36ac",
        spById.get("3_5_8").getVersion());
  }
}
