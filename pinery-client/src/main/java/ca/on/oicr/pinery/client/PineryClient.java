...
/**
 * This is the main class used for retrieving data from the Pinery webservice. It contains "child"
 * clients for each available resource type.
 *
 * @author dcooke
 */
public class PineryClient implements AutoCloseable {
  ...
  /**
   * Creates a new PineryClient to communicate with the Pinery web service at the specified URL.
   * Note that the client is considered "open" upon creation, and the close() method should be
  ...
  /**
   * Makes a GET request to the Pinery web service. The caller is responsible for calling close() on
   * the returned Response object once consumed.
   *
   * @param resourceUrl resource url relative to the Pinery base URL
   * @return Response object containing the requested resource data. This object should be closed
  ...
  /**
   * @return a SampleTypeClient to be used for retrieving SampleType resources from this Pinery
   *     client.
   */
  ...
  /**
   * @return a SequencerRunClient to be used for retrieving SequencerRun resources from this Pinery
   *     client.
   */
  ...
  /**
   * @return an AttributeNameClient to be used for retrieving AttributeName resources from this
   *     Pinery client.
   */
  ...
  /**
   * @return a ChangeLogClient to be used for retrieving ChangeLog resources from this Pinery
   *     client.
   */
  ...
  /**
   * @return an InstrumentClient to be used for retrieving Instrument resources from this Pinery
   *     client.
   */
  ...
  /**
   * @return an InstrumentModelClient to be used for retrieving InstrumentModel resources from this
   *     Pinery client.
   */
  ...
  /** @return a BoxClient to be used for retrieving Box resources from this Pinery client. */
  public BoxClient getBox() {
    checkIfOpen();
    if (boxes == null) boxes = new BoxClient(this);
    return boxes;
  }
  ...
  /**
   * @return an LaneProvenanceClient to be used for retrieving LaneProvenance resources from this
   *     Pinery client.
   */
  ...
  private void checkIfOpen() {
    if (!open)
      throw new IllegalStateException("This PineryClient is closed, and can no longer be used.");
  }

  /**
   * Closes the client instance, and its contained resources. Attempts to use a closed PineryClient
   * will result in an IllegalStateException being thrown. Subsequent calls to this method have no
