...
public class HttpResponseException extends Exception {
  ...
  /**
   * Constructs an HttpResponseException representing the specified status code returned from the
   * specified URL
   *
  ...
  /**
   * @return the status that caused this exception. Contains the status code, family, and reason
   *     phrase
   */
