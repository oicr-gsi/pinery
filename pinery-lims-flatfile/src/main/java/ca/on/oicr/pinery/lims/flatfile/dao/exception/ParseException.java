...
/**
 * Runtime exception for parsing data from LIMS flat files. Will be thrown if any part of a String
 * cannot be parsed
 */
public class ParseException extends RuntimeException {
  ...
  /**
   * Factory method to create a ParseException which indicates the point in the String where the
   * error occurred
   *
   ...
   */
  public static ParseException fromErrorData(
      String badString, int errorPosition, String detailMessage) {
