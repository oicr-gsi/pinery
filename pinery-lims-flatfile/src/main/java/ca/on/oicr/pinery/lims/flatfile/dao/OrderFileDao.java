...
public class OrderFileDao implements OrderDao {
  ...
  private static final String queryOrderById = queryAllOrders + " WHERE id LIKE ?";

  private static final RowMapper<Order> orderMapper =
      new RowMapper<Order>() {
        ...
        private Set<OrderSample> parseOrderSamples(String samplesString) {
          ...
          for (String sampleString : sampleStrings) {
            ...
            Map<String, String> attributeMap =
                DaoUtils.parseKeyValuePairs(sampleMap.get("attributes"));
