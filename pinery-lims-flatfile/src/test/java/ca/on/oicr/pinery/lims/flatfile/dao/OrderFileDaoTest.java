...
public class OrderFileDaoTest {
  ...
  @Autowired private OrderFileDao dao;
  ...
  public void testGetSingleOrderAndMapping() {
    ...
    Assert.assertEquals(
        ModelUtils.convertToDate("2011-11-03T10:50:12-04:00"), order.getCreatedDate());
    Assert.assertEquals(Integer.valueOf(2), order.getCreatedById());
    Assert.assertEquals(
        ModelUtils.convertToDate("2011-11-03T10:50:12-04:00"), order.getModifiedDate());
