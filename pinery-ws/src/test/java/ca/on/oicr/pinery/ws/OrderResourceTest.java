...
public class OrderResourceTest {
   ...
   //
   // when(uriInfoMock.getAbsolutePathBuilder().build()).thenReturn(new
   // URI("http://test/order/1"));
   // when(uriInfoMock.getAbsolutePathBuilder().path("order/").build()).thenReturn(new
   // URI("http://test/order/1"));
   //
   ...
   // status = attributeContainsName(orderDtoSample.getAttributes(),
   ...
   // attributeDtoSet.add(attributeDto);
   // orderDtoSample.setAttributes(attributeDtoSet);
   // status = attributeContainsValue(orderDtoSample.getAttributes(),
   ...
   // when(uriInfoMock.getBaseUriBuilder().path("order/")).thenReturn(uriBuilderMock);
   //
   // when(uriInfoMock.getBaseUriBuilder().build()).thenReturn(new
   // URI("http://test/order"));
   // when(uriInfoMock.getBaseUriBuilder().path("order").build()).thenReturn(new
   // URI("http://test/order"));
   //
   // OrderService orderService = mock(OrderService.class);
   ...
   //
   // assertThat(originalListOrderDto,
   // containsInAnyOrder(listOrderDto.toArray()));
   // }
   //
   ...
   // }
   //
   // public boolean attributeContainsName(Set<AttributeDto> attribute, String
   // attributeName) {
   //
   ...
   // }
   //
   // public boolean attributeContainsValue(Set<AttributeDto> attribute, String
   // attributeValue) {
   //
   // for (AttributeDto dto : attribute) {
