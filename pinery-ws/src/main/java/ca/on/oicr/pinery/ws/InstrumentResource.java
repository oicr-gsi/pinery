...
public class InstrumentResource {
   ...
   public InstrumentModelDto getInstrumentModel(UriComponentsBuilder uriBuilder,
   ...
   public List<InstrumentDto> getInstrumentsModelInstrument(UriComponentsBuilder uriBuilder,
         @ApiParam(value = "ID of instrument model to fetch instruments for") @PathVariable("id") Integer id) {
   ...
   public InstrumentDto getInstrument(UriComponentsBuilder uriBuilder,
