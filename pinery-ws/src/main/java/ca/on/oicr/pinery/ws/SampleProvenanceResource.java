...
public class SampleProvenanceResource {
  ...
  private static final VersionTransformer<SampleProvenance, SimpleSampleProvenance> v3Transformer =
      input -> {
  ...
  private static final VersionTransformer<SampleProvenance, SimpleSampleProvenance> v2Transformer =
      input -> {
  ...
  private static final VersionTransformer<SampleProvenance, SimpleSampleProvenance> v1Transformer =
      input -> {
  ...
  @ApiOperation(
      value = "Get all sample provenance records",
      response = SampleProvenanceDto.class,
