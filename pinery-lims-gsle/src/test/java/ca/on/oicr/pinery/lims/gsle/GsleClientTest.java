...
public class GsleClientTest {
  ...
  /**
   * A single order containing two samples. One sample with two attributes and another sample with
   * three attributes.
   */
  ...
  public void test_sample_Run_map_with_one_Run() throws Exception {
    ...
    Table<Integer, Integer, Set<RunSample>> table =
        sut.positionMapGenerator(get_temporary_list_test_input_three());
  ...
  public void test_sample_run_map_with_two_runs() throws Exception {
    GsleClient sut = new GsleClient();
    Table<Integer, Integer, Set<RunSample>> table =
        sut.positionMapGenerator(get_temporary_list_test_input_four());
  ...
  public void test_fix_directory() {
    assertThat(
        GsleClient.fixRunDirectory(
            "151202_D00331_0148_BC863AANXX", "/tmp/151202_D00331_0148_BC863AANXX"),
        is("/tmp/151202_D00331_0148_BC863AANXX"));
    assertThat(
        GsleClient.fixRunDirectory(
            "151202_D00331_0148_BC863AANXX", "/tmp/151202_D00331_0148_BC863AANXX/jsonReport"),
        is("/tmp/151202_D00331_0148_BC863AANXX"));
    assertThat(
        GsleClient.fixRunDirectory(
            "151202_D00331_0148_BC863AANXX", "/151202_D00331_0148_BC863AANXX/jsonReport"),
        is("/151202_D00331_0148_BC863AANXX"));
    assertThat(
        GsleClient.fixRunDirectory("151202_D00331_0148_BC863AANXX", "/tmp/missing/jsonReport"),
        is(nullValue()));
    assertThat(
        GsleClient.fixRunDirectory("missing", "/tmp/151202_D00331_0148_BC863AANXX/jsonReport"),
        is(nullValue()));
    assertThat(
        GsleClient.fixRunDirectory(
            "151202_D00331_0148_BC863AANXX", "/tmp/151202_D00331_0148_BC863AANXX_fail/jsonReport"),
        is(nullValue()));
  }
