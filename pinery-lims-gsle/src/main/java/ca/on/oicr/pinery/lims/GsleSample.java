...
public class GsleSample extends DefaultSample {
    ...
    * 
    * @see <a
    *      href="https://wiki.oicr.on.ca/display/MCPHERSON/LIMS+Guidelines#LIMSGuidelines-LibraryNomencalture">https://wiki.oicr.on.ca/display/MCPHERSON/LIMS+Guidelines#LIMSGuidelines-LibraryNomencalture</a>
   ...
   public void setPrepKitDescription(String description) {
      if (description != null && !description.equals("")) getOrCreatePreparationKit().setDescription(description);
   }
